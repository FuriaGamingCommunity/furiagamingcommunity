...
if ( ! function_exists( 'furiagamingcommunity_setup' ) ) :
/**
 ...
 *
 * Create your own furiagamingcommunity_setup() function to override in a child theme.
 *
 * @since Furia Gaming Community 1.0
 */
function furiagamingcommunity_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'furiagamingcommunity' ),
		'social'  => __( 'Social Links Menu', 'furiagamingcommunity' ),
	) );
 ...
 * @since Furia Gaming Community 1.0
 */
function furiagamingcommunity_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'furiagamingcommunity_content_width', 840 );
}
add_action( 'after_setup_theme', 'furiagamingcommunity_content_width', 0 );
...
function furiagamingcommunity_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your sidebar.', 'furiagamingcommunity' ),
	...
	register_sidebar( array(
		'name'          => __( 'Content Bottom 1', 'furiagamingcommunity' ),
		'id'            => 'sidebar-2',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'furiagamingcommunity' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar( array(
		'name'          => __( 'Content Bottom 2', 'furiagamingcommunity' ),
		'id'            => 'sidebar-3',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'furiagamingcommunity' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
 ...
 */
function furiagamingcommunity_fonts_url() {
	$fonts_url = '';
	$fonts     = array();
 ...
 * @since Furia Gaming Community 1.0
 */
function furiagamingcommunity_javascript_detection() {
	echo "<script>(function(html){html.className = html.className.replace(/\bno-js\b/,'js')})(document.documentElement);</script>\n";
}
add_action( 'wp_head', 'furiagamingcommunity_javascript_detection', 0 );
 ...
 * @since Furia Gaming Community 1.0
 */
function furiagamingcommunity_scripts() {
	// Add custom fonts, used in the main stylesheet.
	wp_enqueue_style( 'furiagamingcommunity-fonts', furiagamingcommunity_fonts_url(), array(), null );
	...
	wp_localize_script( 'furiagamingcommunity-script', 'screenReaderText', array(
		...
		'collapse' => __( 'collapse child menu', 'furiagamingcommunity' ),
	) );
}
add_action( 'wp_enqueue_scripts', 'furiagamingcommunity_scripts' );
 ...
 */
function furiagamingcommunity_body_classes( $classes ) {
...
add_filter( 'body_class', 'furiagamingcommunity_body_classes' );
 ...
 */
function furiagamingcommunity_hex2rgb( $color ) {
	$color = trim( $color, '#' );
 ...
 */
function furiagamingcommunity_content_image_sizes_attr( $sizes, $size ) {
	$width = $size[0];
...
add_filter( 'wp_calculate_image_sizes', 'furiagamingcommunity_content_image_sizes_attr', 10 , 2 );
 ...
 */
function furiagamingcommunity_post_thumbnail_sizes_attr( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'furiagamingcommunity_post_thumbnail_sizes_attr', 10 , 3 );
 ...
 */
function furiagamingcommunity_widget_tag_cloud_args( $args ) {
	$args['largest'] = 1;
	$args['smallest'] = 1;
	$args['unit'] = 'em';
	return $args;
